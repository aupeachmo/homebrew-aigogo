...
The release workflow in `aupeachmo/aigogo` uses a GitHub App to push formula updates to this repository. This produces signed ("Verified") commits and never expires.
